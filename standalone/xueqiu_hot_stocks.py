...
st.set_page_config(page_title="Xueqiu Hot Stocks", page_icon="chart_with_upwards_trend", layout="wide", initial_sidebar_state="expanded")
...
def main():
    ...
    if view == L["heatmap"]:
        ...
        # 应用样式
        styled = dfd.style.applymap(color_chg, subset=['Chg%', 'Chg'] if 'Chg' in dfd.columns else ['Chg%'])
